package com.capgemini.academy.quarkus.domain.dao;
...
import com.capgemini.academy.quarkus.domain.model.Animal_;
...
public class AnimalDAO extends AbstractDAO<Animal> {
    ...
    @Counted(value = "metric.searchByCriteria", description = "Number of times Dao.searchByCriteria was called", extraTags = {"extra", "tag"})
    public PageResult<Animal> searchByCriteria(AnimalSearchCriteria criteria) {
        ...
        tracer.activeSpan()
                .setTag("predicates", predicates.size())
                .setTag("layer", "dao");
